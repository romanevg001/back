...
class ItemsControllerParent {
}
__decorate([
    common_1.Inject(),
    __metadata("design:type", items_service_1.ItemsService)
], ItemsControllerParent.prototype, "itemsService", void 0);
exports.ItemsControllerParent = ItemsControllerParent;
let ItemsController = class ItemsController extends ItemsControllerParent {
    constructor() {
        super();
    }
    listItems(sss) {
