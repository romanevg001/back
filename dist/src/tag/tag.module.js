...
TagModule = __decorate([
    common_1.Module({
        imports: [typeorm_1.TypeOrmModule.forFeature([tag_entity_1.TagEntity, psrobject_entity_1.PsrobjectEntity])],
        controllers: [tag_controller_1.TagController],
        providers: [tag_service_1.TagService, tag_resolver_1.TagResolver],
    })
], TagModule);
